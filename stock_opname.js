...
import"./modulepreload-polyfill.js";import{_ as G,s as p}from"./db_conn.js";import{i as J,c as R}from"./auth.js";import{d as F,p as W}from"./import.js";fetch("navbar.html").then(e=>e.text()).then(async e=>{document.getElementById("navbar").innerHTML=e,(await G(()=>import("./navbar2.js"),__vite__mapDeps([0,1,2]))).setupLogout()}).catch(e=>console.error("Error loading navbar:",e));J();(async()=>await R())();let L;const I=new Set;function q(e){const t=e.getTimezoneOffset()*6e4;return new Date(e.getTime()-t).toISOString().slice(0,16)}function C(e){return e?new Date(e).toISOString():null}function S(e){return e.toLocaleString("id-ID",{timeZone:"Asia/Jakarta",day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function O(e){return e.toLocaleDateString("id-ID",{timeZone:"Asia/Jakarta"})}function g(e,t="success"){const a=document.getElementById("toastContainer");if(!a){console.error("Toast container not found!");return}const n=document.createElement("div");n.className=`toast align-items-center text-white bg-${t==="success"?"success":"danger"} border-0`,n.setAttribute("role","alert"),n.setAttribute("aria-live","assertive"),n.setAttribute("aria-atomic","true"),n.innerHTML=`
    ...
    `,a.appendChild(n),new bootstrap.Toast(n,{autohide:!0,delay:3e3}).show(),n.addEventListener("hidden.bs.toast",()=>{n.remove()})}function D(e){switch(e){case"sesuai":return"bg-success";case"tidak_sesuai":return"bg-warning";case"disesuaikan":return"bg-info";default:return"bg-secondary"}}async function P(e="add",t=null){const a=document.getElementById("stockOpnameModal");a.dataset.mode=e;const n=document.getElementById("tanggal");n.value=q(new Date),document.querySelector("#productsTable tbody").innerHTML="";const s=a.querySelector(".modal-title"),o=document.getElementById("submitLogButton");if(e==="edit"){s.textContent="Edit Stock Opname",o.textContent="Update",a.dataset.logId=t.id,a.dataset.logData=JSON.stringify(t);const i=new Date(t.tanggal);n.value=q(i),await _(!0,t)}else s.textContent="Buat Stock Opname Baru",o.textContent="Simpan",await _(!1)}async function _(e=!1,t=null,a=1,n=10){const s=document.querySelector("#stockOpnameModal table tbody"),o=document.getElementById("selectAll");e&&t&&t.items.forEach(i=>{I.add(i.produk_varian.id)});try{s.innerHTML=`
        ...
        `,a.appendChild(o)}),new bootstrap.Modal(t).show()}async function x(){const e=document.getElementById("stockOpnameModal"),t=document.getElementById("searchInput").value.trim().toLowerCase(),a=document.querySelector("#stockOpnameModal table tbody"),n=document.getElementById("stockOpnameModal").dataset.mode==="edit",s=n&&e.dataset.logData?JSON.parse(e.dataset.logData):null;try{a.innerHTML=`
            ...
            </svg>`,t.onclick=null)}function z(){document.getElementById("searchInput").value="",$();const e=document.getElementById("stockOpnameModal"),t=e.dataset.mode==="edit",a=t&&e.dataset.logData?JSON.parse(e.dataset.logData):null,n=document.querySelector("#stockOpnameModal .page-size-selector"),s=n?parseInt(n.value):10;_(t,a,1,s)}document.addEventListener("DOMContentLoaded",async()=>{await F(),document.querySelectorAll('button[data-bs-toggle="tab"]').forEach(s=>{s.addEventListener("shown.bs.tab",function(o){o.target.id==="riwayat-tab"&&H()})});const t=document.getElementById("history-tab");t&&t.addEventListener("shown.bs.tab",function(){H()}),L=new bootstrap.Modal(document.getElementById("stockOpnameModal")),document.getElementById("createLogButton").addEventListener("click",()=>{P("add"),L.show()});const a=document.getElementById("searchInput"),n=document.getElementById("searchButton");n&&a&&(n.addEventListener("click",()=>{a.value.trim()&&document.getElementById("searchIcon").innerHTML.includes("bi-x")?z():x()}),a.addEventListener("keyup",s=>{$(),s.key==="Enter"&&x()}),a.addEventListener("input",$)),document.getElementById("selectAll").addEventListener("change",function(){document.querySelectorAll(".product-checkbox").forEach(o=>{o.checked=this.checked})}),document.getElementById("submitLogButton").addEventListener("click",U),B(),et(),at(),nt()});window.loadProductsIntoModal=_;
