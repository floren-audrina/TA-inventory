import"./modulepreload-polyfill.js";import{n as B,d as L}from"./import.js";import{s}from"./db_conn.js";import{i as T,c as M}from"./auth.js";fetch("navbar.html").then(t=>t.text()).then(t=>{document.getElementById("navbar").innerHTML=t;const e=document.createElement("script");e.type="module",e.src=B,document.body.appendChild(e)}).catch(t=>console.error("Error loading navbar:",t));T();(async()=>await M())();function _(){$("#supplierTable").DataTable({dom:'<"top"<"row"<"col-md-6"l><"col-md-6 d-flex justify-content-end align-items-center"f>>>rt<"bottom"ip>',language:{search:"",searchPlaceholder:"Cari Supplier",lengthMenu:"Tampilkan _MENU_ entri per halaman",info:"Menampilkan _START_ sampai _END_ dari _TOTAL_ entri",paginate:{first:"Pertama",last:"Terakhir",next:"Berikutnya",previous:"Sebelumnya"}},columnDefs:[{width:"5%",targets:0},{width:"15%",targets:1},{width:"15%",targets:2},{width:"15%",targets:3},{width:"15%",targets:4},{width:"10%",targets:5,orderable:!1}],columns:[{data:"id"},{data:"perusahaan"},{data:"cp"},{data:"no_hp"},{data:"kota"},{data:null,render:function(t,e,a){return`
        ...
        `,e.appendChild(n)})}function b(){const t=document.getElementById("searchInput"),e=document.getElementById("searchIcon");t.value.trim()?e.innerHTML=`
            ...
            </svg>`}function A(){document.getElementById("searchInput").value="",b(),E()}async function q(t){try{const{data:e,error:a}=await s.from("supplier").select("perusahaan").eq("id",t).single();if(a)throw a;const{data:n,error:r}=await s.from("produk").select(`
                id,
                nama,
                var: produk_varian(
                    id,
