import{s as d}from"./db_conn-Cc8gtU8M.js";import{n as $,d as V}from"./import-BouQIIWv.js";import{c as G}from"./auth-D_umN6eZ.js";fetch("navbar.html").then(e=>e.text()).then(async e=>{document.getElementById("navbar").innerHTML=e;const t=await import($);t.setupLogout?t.setupLogout():console.error("setupLogout not found in navbar.js")}).catch(e=>console.error("Error loading navbar:",e));(async()=>await G())();let T,B=null,o={type:null,category:null,subcategory:null,supplier:null,variant:null};const A=new Map([[.25,"1/4 lusin"],[.5,"1/2 lusin"],[1,"1 lusin"]]);function j(){var e,t;document.querySelectorAll('input[name="filterGroup"]').forEach(a=>{a.addEventListener("click",function(r){if(this.checked&&o.type===this.value){this.checked=!1,I();return}o.type=this.value,R()})}),(e=document.getElementById("applyFilter"))==null||e.addEventListener("click",H),(t=document.getElementById("resetFilter"))==null||t.addEventListener("click",I)}async function R(){var t,a;const e=document.getElementById("filterOptionsContainer");switch(e.innerHTML="",document.getElementById("filterCard").classList.remove("d-none"),o.type){case"kategori":e.innerHTML=`
                <div class="mb-3">
