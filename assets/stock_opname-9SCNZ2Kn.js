import{s as p}from"./db_conn-CuK1RHLN.js";import{l as G,c as V,d as J,p as R}from"./import-C1NTNbVL.js";G();(async()=>await V())();let _;function q(e){const t=e.getTimezoneOffset()*6e4;return new Date(e.getTime()-t).toISOString().slice(0,16)}function H(e){return e?new Date(e).toISOString():null}function L(e){return e.toLocaleString("id-ID",{timeZone:"Asia/Jakarta",day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function C(e){return e.toLocaleDateString("id-ID",{timeZone:"Asia/Jakarta"})}function g(e,t="success"){const a=document.getElementById("toastContainer");if(!a){console.error("Toast container not found!");return}const n=document.createElement("div");n.className=`toast align-items-center text-white bg-${t==="success"?"success":"danger"} border-0`,n.setAttribute("role","alert"),n.setAttribute("aria-live","assertive"),n.setAttribute("aria-atomic","true"),n.innerHTML=`
        <div class="d-flex">
            <div class="toast-body">${e}</div>
            <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast"></button>
        </div>
    `,a.appendChild(n),new bootstrap.Toast(n,{autohide:!0,delay:3e3}).show(),n.addEventListener("hidden.bs.toast",()=>{n.remove()})}function O(e){switch(e){case"sesuai":return"bg-success";case"tidak_sesuai":return"bg-warning";case"disesuaikan":return"bg-info";default:return"bg-secondary"}}async function D(e="add",t=null){const a=document.getElementById("stockOpnameModal");a.dataset.mode=e;const n=document.getElementById("tanggal");n.value=q(new Date),document.querySelector("#productsTable tbody").innerHTML="";const s=a.querySelector(".modal-title"),o=document.getElementById("submitLogButton");if(e==="edit"){s.textContent="Edit Stock Opname",o.textContent="Update",a.dataset.logId=t.id,a.dataset.logData=JSON.stringify(t);const i=new Date(t.tanggal);n.value=q(i),await I(!0,t)}else s.textContent="Buat Stock Opname Baru",o.textContent="Simpan",await I(!1)}async function I(e=!1,t=null,a=1,n=10){const s=document.querySelector("#stockOpnameModal table tbody"),o=document.getElementById("selectAll");try{s.innerHTML=`
            <tr>
        ...
        <div class="card">
            ...
            </div>`}}function X(e,t){const a=document.getElementById("activeLogItems");a.innerHTML="",e.forEach(n=>{const s=n.stok!==null?n.stok:"",o=n.produk_varian.jumlah_stok||0,i=o===s?"sesuai":n.status_item_log,d=document.createElement("tr");d.innerHTML=`
        ...
        <div class="text-center my-4">
            ...
            `,n.appendChild(o)}),document.querySelectorAll(".btn-view-details").forEach(s=>{s.addEventListener("click",function(){const o=this.dataset.logId,i=t.find(d=>d.id==o);st(i)})})}catch(t){console.error("Error loading riwayat data:",t),e.innerHTML=`
            <div class="alert alert-danger">
