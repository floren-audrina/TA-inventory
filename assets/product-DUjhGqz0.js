const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/navbar-NLldhkkK.js","assets/import-wcpIJIsu.js","assets/db_conn-CuK1RHLN.js"])))=>i.map(i=>d[i]);
import{_ as $,s as d}from"./db_conn-CuK1RHLN.js";import{c as V,d as G}from"./import-wcpIJIsu.js";async function A(){try{const t=await(await fetch("navbar.html")).text();document.getElementById("navbar").innerHTML=t;const{setupLogout:a}=await $(async()=>{const{setupLogout:r}=await import("./navbar-NLldhkkK.js");return{setupLogout:r}},__vite__mapDeps([0,1,2]));a?a():console.error("setupLogout not found in navbar.js")}catch(e){console.error("Error loading navbar:",e)}}A();(async()=>await V())();let T,B=null,o={type:null,category:null,subcategory:null,supplier:null,variant:null};const j=new Map([[.25,"1/4 lusin"],[.5,"1/2 lusin"],[1,"1 lusin"]]);function R(){var e,t;document.querySelectorAll('input[name="filterGroup"]').forEach(a=>{a.addEventListener("click",function(r){if(this.checked&&o.type===this.value){this.checked=!1,I();return}o.type=this.value,K()})}),(e=document.getElementById("applyFilter"))==null||e.addEventListener("click",C),(t=document.getElementById("resetFilter"))==null||t.addEventListener("click",I)}async function K(){var t,a;const e=document.getElementById("filterOptionsContainer");switch(e.innerHTML="",document.getElementById("filterCard").classList.remove("d-none"),o.type){case"kategori":e.innerHTML=`
                <div class="mb-3">
            ...
            <tr>
              ...
              `).order("id",{ascending:!0});switch(o.type){case"kategori":o.category&&(o.subcategory?t=t.eq("id_subkategori",o.subcategory):t=t.eq("subkategori.kategori.id",o.category));break;case"supplier":o.supplier&&(t=t.eq("id_supplier",o.supplier));break}const{data:a,error:r}=await t;if(r)throw r;const{data:n,error:s}=await d.from("produk_varian").select("*");if(s)throw s;const u=n.reduce((h,p)=>(h[p.id_produk]||(h[p.id_produk]=[]),h[p.id_produk].push(p),h),{});let v=a;o.type==="varian"&&o.variant&&(v=a.filter(h=>{const p=u[h.id]||[],i=p.length>1||p.length===1&&p[0].varian.toLowerCase()!=="standar";return o.variant==="has"?i:o.variant==="none"?!i:!0})),H(v,u)}catch(t){console.error("Error filtering products:",t),m("Gagal memfilter produk","error"),e.innerHTML=`
            <tr>
            ...
            `).ilike("nama",`%${e}%`).order("id",{ascending:!0}),{data:n,error:s}=await d.from("produk").select(`
                ...
                subkategori!inner(id, subkategori, kategori!inner(id, kategori)),
                supplier:supplier (perusahaan, cp)
            `).not("id_supplier","is",null).order("id",{ascending:!0}),u=(n==null?void 0:n.filter(l=>{var c,b,k,f;return((b=(c=l.supplier)==null?void 0:c.perusahaan)==null?void 0:b.toLowerCase().includes(e))||((f=(k=l.supplier)==null?void 0:k.cp)==null?void 0:f.toLowerCase().includes(e))}))||[],{data:v,error:h}=await d.from("produk").select(`
                id, 
                nama, 
                qty_minimum, 
                id_supplier,
                ...
                subkategori!inner(id, subkategori, kategori!inner(id, kategori)),
                supplier:supplier (perusahaan, cp)
            `).not("id_subkategori","is",null).order("id",{ascending:!0}),p=(v==null?void 0:v.filter(l=>{var c,b,k,f,S;return((b=(c=l.subkategori)==null?void 0:c.subkategori)==null?void 0:b.toLowerCase().includes(e))||((S=(f=(k=l.subkategori)==null?void 0:k.kategori)==null?void 0:f.kategori)==null?void 0:S.toLowerCase().includes(e))}))||[];let y=[...a||[],...u,...p].reduce((l,c)=>(l.some(b=>b.id===c.id)||l.push(c),l),[]);if(o.type)switch(o.type){case"kategori":o.category&&(y=y.filter(l=>{var c,b;return o.subcategory?l.id_subkategori===o.subcategory:((b=(c=l.subkategori)==null?void 0:c.kategori)==null?void 0:b.id)===o.category}));break;case"supplier":o.supplier&&(y=y.filter(l=>l.id_supplier===o.supplier));break;case"varian":break}const{data:F,error:M}=await d.from("produk_varian").select("*");if(M)throw M;const P=F.reduce((l,c)=>(l[c.id_produk]||(l[c.id_produk]=[]),l[c.id_produk].push(c),l),{});o.type==="varian"&&o.variant&&(y=y.filter(l=>{const c=P[l.id]||[],b=c.length>1||c.length===1&&c[0].varian.toLowerCase()!=="standar";return o.variant==="has"?b:!b})),H(y,P)}catch(t){console.error("Error searching products:",t),m("Gagal melakukan pencarian","error"),document.getElementById("productTableBody").innerHTML=`
            <tr>
                <td colspan="7" class="text-center text-danger">
                    Gagal memuat data produk
                </td>
            ...
            </tr>`;return}e.forEach(r=>{var u,v,h,p,i;const n=t[r.id]||[],s=document.createElement("tr");s.innerHTML=`
            <td>${r.id}</td>
            <td>${r.nama}</td>
            <td>${((v=(u=r.subkategori)==null?void 0:u.kategori)==null?void 0:v.kategori)||"-"} (${((h=r.subkategori)==null?void 0:h.subkategori)||"-"})</td>
            <td>
