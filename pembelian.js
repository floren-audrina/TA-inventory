...
import"./modulepreload-polyfill.js";import{_ as U,s as h}from"./db_conn.js";import{i as R,c as V}from"./auth.js";import{p as N,d as W,u as z}from"./import.js";fetch("navbar.html").then(t=>t.text()).then(async t=>{document.getElementById("navbar").innerHTML=t,(await U(()=>import("./navbar2.js"),__vite__mapDeps([0,1,2]))).setupLogout()}).catch(t=>console.error("Error loading navbar:",t));R();(async()=>await V())();let T;function M(t){return{dipesan:"secondary",diterima:"success",dibayar:"primary"}[t]||"secondary"}function q(t){return t?new Date(t).toLocaleDateString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"-"}function w(t){if(!t)return"";const e=new Date(t);return new Date(e.getTime()-e.getTimezoneOffset()*6e4).toISOString().slice(0,16)}function A(t){return new Intl.NumberFormat("id-ID",{style:"currency",currency:"IDR",minimumFractionDigits:0}).format(t)}function v(t,e="success"){const r=document.getElementById("toastContainer");if(!r){console.error("Toast container not found!");return}const a=document.createElement("div");a.className=`toast align-items-center text-white bg-${e==="success"?"success":"danger"} border-0`,a.setAttribute("role","alert"),a.setAttribute("aria-live","assertive"),a.setAttribute("aria-atomic","true"),a.innerHTML=`
        <div class="d-flex">
                        ...
                        <div class="modal-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Total Dibayarkan:</strong> ${A(e.total_dibayarkan)}</p>
